...
fn ServerWhiteListImportUI() {}
fn ServerWhiteListExportUI() {}
fn ServerWhiteListClearUI() {}
fn ServerWhiteListSaveUI() {}
fn ServerWhiteListLoadUI() {}
fn ServerKickUI() {}
fn ServerBanUI() {}
fn ServerUnbanUI() {}
fn ServerWhitelistAddUI() {}
fn ServerWhitelistRemoveUI() {}
fn ServerWhitelistListUI() {}
fn ServerStatusUI() {}
fn ServerStartUI() {}
fn ServerStopUI() {}
fn ServerRestartUI() {}
fn ServerConnectUI() {}
fn ServerDisconnectUI() {}
fn ServerSettingsUI() {}
fn ServerChatUI() {}
fn main() {
    Framework::<Game>::new()
