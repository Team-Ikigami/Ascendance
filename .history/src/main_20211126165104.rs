...
pub fn OpeningUI(ui: &mut UserInterface) {
    ...
    GridBuilder::new(
        WidgetBuilder::new()
            ...
            .with_child(
                MenuBuilder::new(WidgetBuilder::new().with_vertical_alignment(VerticalAlignment::Center).with_horizontal_alignment(HorizontalAlignment::Center))
                    .with_items(
                        MenuItemBuilder::new(
                            WidgetBuilder::new()
                                .on_row(0)
                        ...
                        .with_content(text("New Game").icon("assets/textures/icons/Savegameicon.png"))
                        ...
                        .with_content(text("Exit").shortcut("newgame").icon("assets/textures/icons/Loadgameicon.png"))
                        .with_back("assets/textures/backgrounds/itemsrectanglebackgound.png")
                        .build(ctx),
                        MenuItemBuilder::new(
                            WidgetBuilder::new()
                        ...
                        .with_content(text("Settings").shortcut("").icon("/assets/textures/icons/settings.png"))
                        .with_back("assets/textures/backgrounds/itemsrectanglebackgound.png")
                        .build(ctx),
                        MenuItemBuilder::new(
                            WidgetBuilder::new()
