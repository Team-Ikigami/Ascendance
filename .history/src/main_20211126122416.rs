...
const RUSTY_SHIELD: RecipeStruct = RecipeStruct {
    name: "Rusty Shield",
    ingredients: vec![
        Ingredient {
            item: IRON_INGOT,
    ...
    result: RUSTY__IRON_SHIELD,
};
const RUSTY__IRON_HELMET: RecipeStruct = RecipeStruct {
    name: "Rusty Helmet",
    ingredients: vec![
        Ingredient {
            item: IRON_INGOT,
...
// functions
fn ThreeCoreBasicBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn ThreeCoreMediumBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn ThreeCoreAdvancedBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn ThreeCoreGodlyBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn FiveCoreBasicBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn FiveCoreMediumBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn FiveCoreAdvancedBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn FiveCoreGodlyBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn TenCoreBasicBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn TenCoreMediumBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn TenCoreAdvancedBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn TenCoreGodlyBrewingTable(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn MetalBasicAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn MetalMediumAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn MetalAdvancedAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
    GridBuilder::new(
        WidgetBuilder::new()
            .with_child(
...
fn MetalGodlyAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn RefinedBasicAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn RefinedMediumAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn RefinedAdvancedAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn RefinedGodlyAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
fn NobleBasicAnvil(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
}
...
pub fn OpeningUI(ui: &mut UserInterface) {
    let ctx = &mut ui.build_ctx();
    GridBuilder::new(
        WidgetBuilder::new()
            .with_back(
                ...
                MenuBuilder::new(
                    .with_items(
                        ...
                        .with_content(
                            .text("Settings")
                            .shortcut("")
                            .icon("/assets/textures/icons/settings.png")
                        )
                        .with_back("assets/textures/backgrounds/itemsrectanglebackgound.png")
                        .build(ctx),
                        MenuItemBuilder::new(
